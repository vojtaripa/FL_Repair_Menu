...
fileloc = c:\Program Files (x86)\peak menu\
...
if (listcntr > 42 && listcntr <78) ;1124 devices
	{
		1124 := true
...
MXToolbox:
{
Run, C:\Program Files (x86)\Google\Chrome\Application\Chrome.exe http://mxtoolbox.com/,,UseErrorlevel
If ErrorLevel = ERROR
	GoSub, Messageit11
Sleep, 500
Return
...
MACfind:
{
Run, C:\Program Files (x86)\Google\Chrome\Application\Chrome.exe http://www.coffer.com/mac_find/,,UseErrorlevel
If ErrorLevel = ERROR
	GoSub, Messageit11
Sleep, 1800
Return
...
Neustar:
{
Run, C:\Program Files (x86)\Google\Chrome\Application\Chrome.exe http://numbering.neustar.biz/,,UseErrorlevel
If ErrorLevel = ERROR
	GoSub, Messageit11
Sleep, 1800
Return
...
Fairpoint:
{
Run, C:\Program Files (x86)\Google\Chrome\Application\Chrome.exe https://vfoprod-fairpoint.activationnow.com/,,UseErrorlevel
If ErrorLevel = ERROR
	GoSub, Messageit11
Sleep, 1800
Return
...
Speedtest:
{
Run, C:\Program Files (x86)\Internet Explorer\iexplore.exe http://speedtest.firstlight.net/,,UseErrorlevel
If ErrorLevel = ERROR
	GoSub, Messageit11
WinActivate, 
Sleep, 1800
...
O360:
{
loc = "C:\Program Files (x86)\peak menu\omnia360 repair 062017.pdf"
Run, C:\Program Files (x86)\Google\Chrome\Application\Chrome.exe %loc%,,UseErrorlevel
If ErrorLevel = ERROR
	GoSub, Messageit11
Sleep, 1800
Return
...
Run, C:\Program Files (x86)\ONDA\ONDA.exe,,UseErrorlevel
If ErrorLevel = ERROR
	GoSub, Messageit11
Sleep, 1500
Return
