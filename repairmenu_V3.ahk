...
{
menutitle = v.3 NOC REPAIR MENU 2019 ;07/11/2017 -> 02-13-2019
...
nocTier1 = \shared\NOC-Tier 1 ; ; \\firstlight.net\groups\legacyshares\on
...
arrOxford[52] := "10.3.5.36" ;Bethel COT
arrOxford[53] := "10.3.5.20" ;Bethel2
arrOxford[54] := "10.3.100.73" ;Intervale Rd
arrOxford[55] := "10.3.100.74" ;Vernon St
arrOxford[56] := "10.3.100.112" ;Buckfield
arrOxford[57] := "10.3.100.34" ;Spring Rd
arrOxford[58] := "10.3.100.94" ;Bryant Pond
arrOxford[59] := "10.3.23.2" ;Biddeford
arrOxford[60] := "10.3.100.109" ;Canton
arrOxford[61] := "10.3.100.46" ;Stetson Rd
arrOxford[62] := "10.3.100.43" ;Brighton Hill
arrOxford[63] := "10.3.100.42" ;E Hebron
arrOxford[64] := "10.3.100.52" ;Hebron
arrOxford[65] := "10.3.100.68" ;Sodom Rd
arrOxford[66] := "10.3.100.116" ;Hanover
arrOxford[67] := "10.3.100.114" ;Locke Mills
arrOxford[68] := "10.3.100.84" ;Greenwood Rd
arrOxford[69] := "10.3.100.28" ;N Norway
arrOxford[70] := "10.3.8.9" ;Norway
arrOxford[71] := "10.3.100.41" ;Pleasant Pond
arrOxford[72] := "10.3.100.91" ;N Turner
arrOxford[73] := "10.3.100.89" ;Bear Pond Rd
arrOxford[74] := "10.3.100.44" ;Sunday River
arrOxford[75] := "10.3.100.13" ;N Newry
arrOxford[76] := "10.3.100.4" ;Roxbury Pond
arrOxford[77] := "10.3.11.21" ;Sumner COT
arrOxford[78] := "10.3.100.108" ;W Sumner
arrOxford[79] := "10.3.100.88" ;Lower Sumner Hill
arrOxford[80] := "10.3.100.55" ;Shagg Pond
arrOxford[81] := "10.3.100.29" ;S Paris
arrOxford[82] := "10.3.3.32" ;Turner COT
arrOxford[83] := "10.3.3.5" ;Turner2
arrOxford[84] := "10.3.100.113" ;Upper St
arrOxford[85] := "10.3.100.54" ;Blue Rock
arrOxford[86] := "10.3.100.5" ;Upton
arrOxford[87] := "10.3.100.50" ; Tuell Town
arrOxford[88] := "10.3.100.93" ;W Paris1
arrOxford[89] := "10.3.100.115" ;W Paris2
...
arrOxfordName[52] := "BETHMEXAAT1-Bethel COT 5k"
arrOxfordName[53] := "BETHMEXAAT2-Bethel2 5k"
arrOxfordName[54] := "BCFDMEXAAT1-Intervale Rd 5k"
arrOxfordName[55] := "BETHMEVEAT1-Vernon St 5k"
arrOxfordName[56] := "BCFDMEXAAT1-Buckfield 5k"
arrOxfordName[57] := "BCFDMESRAT1-Spring Rd 5k"
arrOxfordName[58] := "BRPNMEXAAT1-Bryant Pond 5k"
arrOxfordName[59] := "BDFRMEJEAT2-Biddeford 5k"
arrOxfordName[60] := "CNTNMEXAAT1-Canton 5k"
arrOxfordName[61] := "CNTNMESTAT1-Stetson Rd 5k"
arrOxfordName[62] := "HBRNMEBRAT1-BrightonHill 5k"
arrOxfordName[63] := "HBRNMEBUAT1-E Hebron 5k"
arrOxfordName[64] := "HBRNMEXAAT1-Hebron 5k"
arrOxfordName[65] := "HBRNMESOAT1-Sodom Rd 5k"
arrOxfordName[66] := "HNVRMEMAAT1-Hanover 5k"
arrOxfordName[67] := "LCMLMEXAAT1-Locke Mills 5k"
arrOxfordName[68] := "NNWYMEGRAT1-Greenwood Rd 5k"
arrOxfordName[69] := "NNWYMEXAAT1-N Norway 5k"
arrOxfordName[70] := "NRWYME04AT1-Norway 5k"
arrOxfordName[71] := "NTRNMEPLAT1-Pleasant Pond 5k"
arrOxfordName[72] := "NTRNMEXAAT1-N Turner 5k"
arrOxfordName[73] := "NTRNMEBPAT1-Bear Pond Rd 5k"
arrOxfordName[74] := "NWRYMESKAT1-Sunday River 5k"
arrOxfordName[75] := "NWRYMEBRAT1-N Newry 5k"
arrOxfordName[76] := "RXPDMEXAAT1-Roxbury Pond 5k"
arrOxfordName[77] := "SMNRMEXAAT1-Sumner COT 5k"
arrOxfordName[78] := "SMNRMEMAAT1-W Sumner 5k"
arrOxfordName[79] := "SMNRMELSAT1-Lower Sumner Hill 5k"
arrOxfordName[80] := "SMNRMESPAT1-Shagg Pond 5k"
arrOxfordName[81] := "STPRMEWEAT1-S Paris 5k"
arrOxfordName[82] := "TRNRMEXAAT1-Turner COT 5k"
arrOxfordName[83] := "TRNRMEXAAT2-Turner2 5k"
arrOxfordName[84] := "TRNRMECEAT1-Upper St 5k"
arrOxfordName[85] := "TRNRMEWOAT1-Blue Rock 5k"
arrOxfordName[86] := "UPTNMEXAAT1-Upton 5k"
arrOxfordName[87] := "WPRSMETUAT1-Tuell Town 5k"
arrOxfordName[88] := "WPRSMEXAAT1-West Paris1 5k"
arrOxfordName[89] := "WPRSMEXAAT2-West Paris2 5k"
...
arr[14] := "192.168.69.6" ;HMPNNHW1AT2 / Hampton NEW
arr[15] := "192.168.120.47" ;Laconia1
arr[16] := "192.168.120.48" ;Laconia2
arr[17] := "192.168.120.50" ;Lawrence1
arr[18] := "192.168.120.13" ;Lawrence2
arr[19] := "192.168.120.85" ;Lowell
arr[20] := "192.168.120.19" ;Malden
arr[21] := "192.168.120.51" ;Manchester1
arr[22] := "192.168.120.52" ;Manchester2
arr[23] := "192.168.120.49" ;Manchester3
arr[24] := "192.168.120.86" ;Milford
arr[25] := "192.168.120.111" ;Music Hall
arr[26] := "192.168.120.54" ;Nashua1
arr[27] := "192.168.120.55" ;Nashua2
arr[28] := "192.168.120.87" ;Newburyport1
arr[29] := "192.168.120.14" ;Newburyport2
arr[30] := "192.168.120.88" ;Newmarket
arr[31] := "192.168.120.11" ;Peabody
arr[32] := "192.168.120.89" ;Pease
arr[33] := "192.168.120.90" ;Portland1
arr[34] := "192.168.120.91" ;Portland2
arr[35] := "192.168.120.56" ;Portsmouth1
arr[36] := "192.168.120.57" ;Portsmouth2
arr[37] := "192.168.120.115" ;Riverwoods - Ridge- 
arr[38] := "192.168.120.116" ;Riverwoods - Boulders- 
arr[39] := "192.168.120.117" ;Riverwoods - Woods- 
arr[40] := "192.168.120.58" ;Rochester1
arr[41] := "192.168.120.59" ;Rochester2
arr[42] := "192.168.120.60" ;Rochester3
arr[43] := "192.168.120.92" ;Rye Beach
arr[44] := "192.168.120.61" ;Salem
arr[45] := "192.168.120.62" ;Seabrook
arr[46] := "192.168.120.93" ;Somersworth
arr[47] := "192.168.120.94" ;Wolfeboro
...
arr1[14] := "HMPNNHW1AT2-Hampton NEW" ;HMPNNHW1AT2 / Hampton NEW
arr1[15] := "LACNNHNMAT1-Laconia1 5k"
arr1[16] := "LACNNHNMAT2-Laconia2 5k"
arr1[17] := "LWRNMACAAT1-Lawrence1 5k"
arr1[18] := "LWRNMACAAT2-Lawrence2 5k"
arr1[19] := "LWLLMAAPAT1-Lowell 5k"
arr1[20] := "MLDNMAELAT1-Malden 5k"
arr1[21] := "MNCHNHCOAT1-Manchester1 5k"
arr1[22] := "MNCHNHCOAT2-Manchester2 5k"
arr1[23] := "MNCHNHCOAT3-Manchester3 5k"
arr1[24] := "MLFRNHSOAT1-Milford 5k"
arr1[25] := "PTMONHMHAT1-Music Hall 5k"
arr1[26] := "NASHNHWPAT1-Nashua1 5k"
arr1[27] := "NASHNHWPAT2-Nashua2 5k"
arr1[28] := "NBPTMAGRAT1-Newburyport1 5k"
arr1[29] := "NBPTMAGRAT2-Newburyport2 5k"
arr1[30] := "NWMRNHGEAT1-Newmarket 5k"
arr1[31] := "PBDYMACEAT1-Peabody 5k"
arr1[32] := "PTMONH07AT1-Pease /Tradeport 5k" ;added tradeport
arr1[33] := "PTLDMEFOAT1-Portland1 5k"
arr1[34] := "PTLDMEFOAT2-Portland2 5k"
arr1[35] := "PTMONHISAT1-Portsmouth1 5k"
arr1[36] := "PTMONHISAT2-Portsmouth2 5k"
arr1[37] := "EXTRNHR1WAT1-Riverwoods-Ridge" ;192.168.120.115" ;Riverwoods - Ridge- 
arr1[38] := "EXTRNH5TAT1-Riverwoods-Boulders" ;192.168.120.116" ;Riverwoods - Boulders- 
arr1[39] := "EXTRNH7RAT1-Riverwoods-Woods" ;192.168.120.117" ;Riverwoods - Woods- 
arr1[40] := "ROCHNHWEAT1-Rochester1 5k"
arr1[41] := "ROCHNHWEAT2-Rochester2 5k"
arr1[42] := "ROCHNHWEAT3-Rochester3 5k"
arr1[43] := "RYBHNHCEAT1-Rye Beach 5k"
arr1[44] := "SALMNHNBAT1-Salem 5k"
arr1[45] := "SBRKNHNRAT1-Seabrook 5k"
arr1[46] := "SBRKNHNRAT1-Somersworth 5k"
arr1[47] := "WLBONHGSAT1-Wolfeboro 5k"
...
arrCS15tasks[2]   := "que stn"  ;issue with the %tn%
arrCS15tasks[4]   := "" ;KEEN
arrCS15tasks[5]   := "" ;KEEN
arrCS15tasks[6]   := "" ;KEEN
arrCS15tasks[7]   := "" ;KEEN
...
arrCS15tasks[9]   := "" ;KEEN
;SKIPPED KEEN
arrCS15tasks[10]  := " " ;KEEN
arrCS15tasks[11]  := " " ;KEEN
arrCS15tasks[12]  := " " ;KEEN
arrCS15tasks[13]  := " " ;KEEN
arrCS15tasks[14]  := " " ;KEEN
arrCS15tasks[15]  := " " ;KEEN
arrCS15tasks[16]  := " " ;KEEN
...
*/
arrCS15title := Object()
arrCS15title[0]  := "CS15 Tasks|"
arrCS15title[1]  := "------------- Task list---------------"
arrCS15title[2]  := "Check Line / Phone number"
arrCS15title[3]  := "--- More ---" ;OTHER 5ks
arrCS15title[4]  := "Bouncing line POTs" ;OTHER 5ks
arrCS15title[5]  := "Bouncing line DID" ;OTHER 5ks
arrCS15title[6]  := "Forwarding line POTs" ;OTHER 5ks
arrCS15title[7]  := "Forwarding line DID" ;OTHER 5ks
arrCS15title[8]  := "checking call history" ;OTHER 5ks
arrCS15title[9]   := "" ;OTHER 5ks
arrCS15title[10]  := "" ;OTHER 5ks
arrCS15title[11]  := "" ;OTHER 5ks
arrCS15title[12]  := "" ;OTHER 5ks
arrCS15title[13]  := "" ;OTHER 5ks
arrCS15title[14]  := "" ;OTHER 5ks
arrCS15title[15]  := "" ;OTHER 5ks
arrCS15title[16]  := "" ;OTHER 5ks
}
...
list25 = FirstLight Fiber||JumpBox|CPE T-Mark340|Solarwinds|Edge Gene|Planet Operate|OneControl|AnyConnectVPN|FirstLightVPN
...
list27 = G4 Network (3ks & Turnstones)||log into 3k|log into turnstone
...
Gui,1: Add,DropDownList, w275 vanswer12 gchoice12, %list12%  ;Security Tasks  (OTHER)
...
Gui,2: Add, DropDownList, r35 w355 vCS15TaskChoice Choose1 gCS15TaskChosen, %CS15TasksList%
Gui,2: show, x%xpos% y%ypos%,REPAIR
Return
}
;------------------------------------
...
Gui,12: Font, s12 normal, arial
Gui,12: Add,Text, cNAVY x5 y80,TELEPHONE#:
Gui,12: Add,Edit,LIMIT10 NUMBER cNAVY gValueCheckCS15 vcs15guiType w120 x137 y79
;cutTN := RegExReplace(%tn%, "^[0-9]{3}", "")  ; Returns "123" because a match was achieved via the case-insensitive option.
