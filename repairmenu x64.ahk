...
IfWinNotExist %session%
	{
		...
		Run "C:\Program Files\PuTTY\putty.exe" -telnet %session%
		Sleep, 500
		WinActivate, "%session% - PuTTY"
		Sleep, 500
...
IfWinNotExist %ActiveSBC% %ipaddr%
	{
		Run "C:\Program Files\PuTTY\putty.exe" -load "ActiveSBC"
		WinActivate, %ipaddr% - PuTTY
		Sleep, 500
		WinSetTitle, %ipaddr% - PuTTY,, %ActiveSBC% %ipaddr%
		WinActivate, %ActiveSBC% %ipaddr%
...
{
	Run, "C:\Program Files\PuTTY\putty.exe" -load "SBC2"
	Sleep 800
...
Loop, Read, %USERPROFILE%\desktop\Logs\192.168.76.29.txt
	{
		...
		{
			Send, exit{ENTER}
			Run, "C:\Program Files\PuTTY\putty.exe" -load "SBC1"
			Sleep 800
...
IfWinNotExist repair@
	{
		Run "C:\Program Files\PuTTY\putty.exe" -load "Autoprov"
...
IfWinNotExist %a2820% %ipaddr%
	{
		Run "C:\Program Files\PuTTY\putty.exe" -load "%a2820%"
		WinActivate, %ipaddr% - PuTTY
		Sleep, 1800
...
IfWinNotExist %Infi% %ipaddr%
	{
		Run "C:\Program Files\PuTTY\putty.exe" -load "%Infi%"
		WinActivate, %Infi%
		Sleep, 1800
...
IfWinNotExist %1124% %ipaddr%
	{
		Run "C:\Program Files\PuTTY\putty.exe" -load "%1124%"
		WinActivate, %1124%
		Sleep, 1800
...
IfWinNotExist Albany Switch 10.1.1.49
	{
		...
		While(waiting)
		Sleep, 500
		Run "C:\Program Files\PuTTY\putty.exe" -load "Albany DMS500 Switch",,UseErrorlevel
		If ErrorLevel = ERROR
			GoSub, Messageit11
		WinActivate,10.1.1.49 - PuTTY
		Sleep, 500
...
IfWinNotExist Albany CS15 Switch 10.1.2.50
	{
		...
		While(waiting)
		Sleep, 500
		Run "C:\Program Files\PuTTY\putty.exe" -load "Albany CS15 Switch",,UseErrorlevel
		If ErrorLevel = ERROR
			GoSub, Messageit11
		WinActivate,10.1.2.50 - PuTTY
		Sleep, 500
...
IfWinNotExist DMS100 Switch 192.168.0.130
	{
		...
		While(waiting)
		Sleep, 500
		Run "C:\Program Files\PuTTY\putty.exe" -load "DMS100",,UseErrorlevel
		If ErrorLevel = ERROR
			GoSub, Messageit11
		WinActivate,192.168.0.130 - PuTTY
		Sleep, 500
...
IfWinNotExist CMS 192.168.3.25
	{
		Run "C:\Program Files\Calix\EMSGui.exe",,UseErrorlevel
		If ErrorLevel = ERROR
			GoSub, Messageit11
		WinActivate, CMS 192.168.3.25
	}
...
IfWinNotExist MetaView Explorer - 192.168.114.30
	{
		Run "C:\Program Files\Metaswitch\MetaView Explorer\metaviewexplorerla.exe",,UseErrorlevel
		If ErrorLevel = ERROR
			GoSub, Messageit11
		WinActivate, MetaView Explorer - 192.168.114.30
		Sleep, 500
...
IfWinNotExist Bethel Inteliflex 10.3.5.9
	{
		Run "C:\Program Files\PuTTY\putty.exe" -load "Bethel-Inteliflex INFI",,UseErrorlevel
		If ErrorLevel = ERROR
			GoSub, Messageit11
		WinActivate,10.3.5.9 - PuTTY
		Sleep, 500
...
IfWinNotExist Gore Rd Inteliflex 10.3.5.27
	{
		Run "C:\Program Files\PuTTY\putty.exe" -load "Gore Rd-Inteliflex INF2",,UseErrorlevel
		If ErrorLevel = ERROR
			GoSub, Messageit11
		WinActivate,10.3.5.27 - PuTTY
		Sleep, 500
...
IfWinNotExist Turner Inteliflex 10.3.3.9
	{
		Run "C:\Program Files\PuTTY\putty.exe" -load "Turner-Inteliflex INFT",,UseErrorlevel
		If ErrorLevel = ERROR
			GoSub, Messageit11
		WinActivate,10.3.3.9 - PuTTY
		Sleep, 500
